package myeslib3.stack1.features.projection;
...
public class SingleNodeEventsProjector {
  ...
  public SingleNodeEventsProjector(int executorsPoolSize,
                                   Runnable runnable,
...
// Not necessary because each executor operates on a SynchronousQueue
//  void shutdown() {
