...
*/
package myeslib3.example1.datamodel.tables;


import myeslib3.example1.datamodel.Example1db;
import myeslib3.example1.datamodel.Keys;
...
public class AggregateRoots extends TableImpl<AggregateRootsRecord> {
    ...
    private static final long serialVersionUID = -730211014;
